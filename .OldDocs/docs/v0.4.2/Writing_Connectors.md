...
permalink: /v0.4.2/writing-connectors/
order: 2
---
...
The integration consists of the following steps (for an example, see the [`caliper-ethereum`](https://github.com/hyperledger/caliper/tree/v0.4.2/packages/caliper-ethereum) connector):
...
5. Add your new package (by name) to the [Caliper CLI dependencies](https://github.com/hyperledger/caliper/blob/v0.4.2/packages/caliper-cli/package.json).
...
const BuiltinConnectors = new Map([
  ...
  ```
7. It is highly recommended to provide [integration tests](https://github.com/hyperledger/caliper/tree/v0.4.2/packages/caliper-tests-integration) for your connector.
