...
describe('AssignedMessage', () => {
    describe('Constructor', () => {
        ...
        it('should parse the date argument as a Date object for the AssignedMessage', () => {
            ...
            message.date.toISOString().should.equal(new Date(date).toISOString());
        });

        it('should set the date as an Invalid Date object if the date string is not a valid date', () => {
