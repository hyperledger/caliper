...
const FixedFeedbackRate = rewire('../../lib/rate-control/fixedFeedbackRate');
...
describe('fixedFeedbackRate controller implementation', () => {
    ...
    describe('#init', () => {
        ...
        it('should set the sleepTime for a single client if no clients are specified and tps is 0', () => {
            let msg = {};
            controller.tps = 0;
            controller.init(msg);
