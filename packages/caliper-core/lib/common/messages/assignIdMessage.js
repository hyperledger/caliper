...
/**
 * Class for the "assignId" message.
 */
class AssignIdMessage extends Message {
    /**
     * Constructor for an "assignId" message instance.
    ...
    constructor(sender, recipients, content, date = undefined, error = undefined) {
        super(sender, recipients, MessageTypes.AssignId, content, date, error);
    }

    /**
     * Gets the assigned zero-based worker index.
     * @return {number} The worker index.
     */
    getWorkerIndex() {
        return this.content.workerIndex;
    }
}

module.exports = AssignIdMessage;
