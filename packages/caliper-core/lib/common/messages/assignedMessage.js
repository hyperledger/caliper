...
/**
 * Class for the "assigned" message.
 */
class AssignedMessage extends Message {
    /**
     * Constructor for a "assigned" message instance.
    ...
    constructor(sender, recipients, date = undefined, error = undefined) {
        super(sender, recipients, MessageTypes.Assigned, {}, date, error);
    }
}

module.exports = AssignedMessage;
