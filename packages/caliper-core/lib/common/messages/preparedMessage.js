...
/**
 * Class for the "prepared" message.
 */
class PreparedMessage extends Message {
    /**
     * Constructor for a "prepared" message instance.
    ...
    constructor(sender, recipients, date = undefined, error = undefined) {
        super(sender, recipients, MessageTypes.Prepared, {}, date, error);
    }
}

module.exports = PreparedMessage;
