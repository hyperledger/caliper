...
module.exports = class extends Generator {
    async prompting () {
        ...
        const callbackQuestions = [{
            ...
            type: 'input',
            name: 'version',
            message: 'What is the version of your contract?',
            when: () => !this.option.version
        }, {
            type: 'input',
            name: 'chaincodeFunction',
            message: 'Which contract function would you like to perform the benchmark on?',
        ...
        const configQuestions = {
            initialQuestions: [{
                type: 'input',
                name: 'name',
                message: 'Name of benchmark:',
                when: () => !this.options.name
            }, {
                type: 'input',
                name: 'description',
                message: 'Description of benchmark:',
            ...
            roundQuestions: [{
                ...
                name: 'label',
                message: 'Label:',
                suffix: '(hint for the test)',
                when: () => !this.options.label
            }, {
                type: 'list',
                name: 'rateController',
                message: 'Rate controller:',
                choices: [
