...
/**
 * Class used to spawn corda client workers
 */
class CordaClientFactory {

    /**
     * Require paths to configuration data used when calling new on corda.js
     ...
     */
    async spawnWorker() {
        const child = childProcess.fork(path.join(__dirname, './cordaClientWorker.js'));
...
module.exports = CordaClientFactory;
