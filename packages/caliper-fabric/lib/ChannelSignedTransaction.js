...
//         sendSignedTransaction(signedCommitProposal) {
//             var orderer = this._clientContext.getTargetOrderer(signedCommitProposal.request.orderer, this._orderers, this._name);
//             return orderer.sendBroadcast(signedCommitProposal.signedProposal);
//         }

//         generateSignedTransaction(request) {
//                 logger.debug('sendTransaction - start :: channel %s', this);
//                 var errorMsg = null;
