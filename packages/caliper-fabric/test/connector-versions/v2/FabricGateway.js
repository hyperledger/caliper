...
const { Gateway, Transaction, Wallets } = require('./GatewayStubs');
...
const FabricGateway = require('../../../lib/connector-versions/v2/FabricGateway');
const WalletFacadeFactory = require('../../../lib/connector-versions/v2/WalletFacadeFactory');
const FabricConnectorContext = require('../../../lib/FabricConnectorContext');
...
describe('A V2 Fabric Gateway', () => {
    ...
    it('should be able to initialise in preperation for use by a caliper master', async () => {
        const fabricGateway = new FabricGateway(null, 1, 'fabric');
