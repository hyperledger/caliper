...
describe('A Fabric Connector Factory', () => {
    ...
    it('should throw an error if no fabric library is bound', async () => {
        ...
        /*
        mockery.registerSubstitute('fabric-network', 'i-dont-exist');
        mockery.registerSubstitute('fabric-client', 'i-dont-exist');
        ConfigUtil.set(ConfigUtil.keys.NetworkConfig, path.resolve(__dirname, v2config2));
        ConfigUtil.set(ConfigUtil.keys.Fabric.Gateway.Enabled, true);
