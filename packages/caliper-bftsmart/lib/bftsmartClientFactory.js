...
/**
 * Class used to spawn bftsmart client workers
 */
class BftsmartClientFactory {

    /**
     * Require paths to configuration data used when calling new on bftsmart.js
     ...
     */
    async spawnWorker() {
        const child = childProcess.fork(path.join(__dirname, './bftsmartClientWorker.js'));
...
module.exports = BftsmartClientFactory;
